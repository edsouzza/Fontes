object _frmVisualizandoVendaConcluida: T_frmVisualizandoVendaConcluida
  Left = 340
  Top = 137
  BorderIcons = [biSystemMenu]
  BorderStyle = bsSingle
  Caption = 'Visualizando venda conclu'#237'da'
  ClientHeight = 650
  ClientWidth = 995
  Color = clBtnFace
  ...
  object pan_titulo: TPanel
    ...
    BorderWidth = 2
    BorderStyle = bsSingle
    Caption = 'Visualizando os '#205'tens da venda n'#186' '
    Color = clMaroon
    Font.Charset = DEFAULT_CHARSET
    Font.Color = clWhite
    Font.Height = -19
