...
type
  T_frmDescontoCotacao = class(TForm)
...
var
  _frmDescontoCotacao: T_frmDescontoCotacao;

implementation

uses U_dmDados, U_dmPesquisas, U_BiblioSysSalao, U_dmDadosSegundo,
  U_Cotacao, U_EscolhaDoProdutoParaCotacao, DateUtils;

{$R *.dfm}


procedure T_frmDescontoCotacao.FormCreate(Sender: TObject);
...
procedure T_frmDescontoCotacao.FormClose(Sender: TObject; var Action: TCloseAction);
begin

    ZerarVariaveis;
    _frmCotacao.AbrirFecharTabelas;
    Close;
    Release;
...
procedure T_frmDescontoCotacao.FormKeyPress(Sender: TObject; var Key: Char);
begin
...
procedure T_frmDescontoCotacao.FormShow(Sender: TObject);
begin

     idDaCotacao                   := _frmCotacao.NumCotacao;
     valorOriginal                 :=  StrToFloat(_frmCotacao.txt_ValorItem.Text);
     quantidade                    :=  StrToFloat(_frmCotacao.edt_quantidadeDoItem.text);

     edt_valorUnitarioAtual.Text   :=  _frmCotacao.txt_ValorItem.Text;

end;


procedure T_frmDescontoCotacao.pnl_rodapeClick(Sender: TObject);
begin
...
procedure T_frmDescontoCotacao.CalcularValorComDesconto;
begin
...
procedure T_frmDescontoCotacao.edt_valorDescontoKeyDown(Sender: TObject;
         ...
         begin
              ...
              _Sql:= 'UPDATE t_cotacao SET unitario = :pNovoUnitario, totalitem = :pNovoTotalItem WHERE '+
               ...
               With DM_Pesq.Qry_Geral do begin
                  ...
                  ParamByName('pIDCotacao').Value     := _frmCotacao.NumCotacao;
...
procedure T_frmDescontoCotacao.CalcularValorDescontoPorPercentual;
begin
...
procedure T_frmDescontoCotacao.edt_percentualDescontoKeyDown(
...
procedure T_frmDescontoCotacao.ZerarVariaveis;
begin
...
procedure T_frmDescontoCotacao.edt_valorDescontoEnter(Sender: TObject);
begin
    ZerarVariaveis;
end;

procedure T_frmDescontoCotacao.rd_valordiretoClick(Sender: TObject);
begin
...
procedure T_frmDescontoCotacao.rd_porpercentualClick(Sender: TObject);
begin
