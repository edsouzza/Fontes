...
begin
    ...
    //atualizando a data atual do sistema na tabela expiracao para eventuais verificações respeito de expiração
...
begin
        ...
        //CONTAR 15 DIAS A PARTIR DO DIA SEGUINTE - TRUNC RETIRA AS CASAS DECIMAIS DO NÚMERO
        ...
        //VERIFICAÇÕES E MENSAGENS DE ACORDO COM A DATA ATUAL
        if ( RetornarDataExpiracao = '01/01/2000' )then
        begin

              // ABRE O FORMULÁRIO DE REGISTRO PARA ADQUIRIR A CHAVE E DAR INICIO AO PROCESSO DE OBTENÇAO DA LICENÇA DEFINITIVA OU INICIAR A DESGUSTAÇÃO DE 15 DIAS
        ...
        begin
                 ...
                 texto := 'Sua  licença  esta  vencida    favor   entrar  em  contato,'#13'estamos a disposição para maiores esclarecimentos no'#13'e-mail : '+email;
                 Application.MessageBox(PChar(texto),'Licença vencida!', MB_OK + MB_ICONERROR);
        ...
        begin
            ...
            texto := 'Faltam      '+floatToStr(QdeDiasParaExpirar)+'    dia(s)     para     vencer      sua     licença,  deseja'#13'adquirir  sua licença e seguir desfrutando do sistema  agora?';
        ...
        begin
            ...
            texto := 'Faltam  apenas  '+floatToStr(QdeDiasParaExpirar)+' dia  para  expirar  sua licença, atente   para   o   fato  de  perda  total  dos  dados  cadastrados  caso   isso  ocorra,  adquira   agora   sua    licença  e   siga   desfrutando  de  tudo que nosso  sistema  lhe  proporciona, vamos nessa?';
            if Application.MessageBox(PChar(texto),'Sobre a Licença!',MB_YESNO + MB_ICONWARNING) = IdYes then
            begin
...
begin
  ...
  //INPUT BOX PARA DIGITAÇÃO DA NOVA SENHA COM CARACTERS DE (*)
...
begin
   ...
   //=======================================================================================
   //CONFIGURAÇÃO DO CLIENTE VENDA BALCAO
...
begin
      ...
      begin
        ...
        try
            ...
            Connected                 := false;
            ConnectionName            :='SYSPDV'; //Nome do Driver válido ***
