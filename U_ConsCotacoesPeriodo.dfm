object _frmConsCotacoesPeriodo: T_frmConsCotacoesPeriodo
  Left = 280
  Top = 15
  ...
  object pangrid_atendimentos: TPanel
    ...
    ShowHint = True
    TabOrder = 1
    object grid_ListaCotacoes: TDBGrid
      Left = 6
      Top = 6
      Width = 977
      Height = 504
      Cursor = crHandPoint
      Hint = 'Abre a cota'#231#227'o selecionada para atualiza'#231#227'o'
      Align = alClient
      Font.Charset = DEFAULT_CHARSET
      Font.Color = clBlack
      Font.Height = -16
      ...
      TitleFont.Style = []
      OnCellClick = grid_ListaCotacoesCellClick
      OnDrawColumnCell = grid_ListaCotacoesDrawColumnCell
      Columns = <
        item
          Expanded = False
          FieldName = 'CLI_NOME'
  ...
  object pan_titulo: TPanel
    ...
    BorderWidth = 2
    BorderStyle = bsSingle
    Caption = 'Consulta e atualiza cota'#231#245'es por per'#237'odo'
    Color = clMaroon
    Font.Charset = DEFAULT_CHARSET
    Font.Color = clWhite
    Font.Height = -19
  ...
  object pan_botoes: TPanel
    ...
    object GroupBox1: TGroupBox
      ...
      object btnImprimirPeriodoCotacao: TSpeedButton
        Left = 138
        Top = 6
        Width = 135
        Height = 44
        Hint = 'Imprime a lista de cota'#231#245'es do per'#237'odo selecionado'
        Caption = 'Imprimir'
        Enabled = False
        Flat = True
        Font.Charset = DEFAULT_CHARSET
        ...
        ParentShowHint = False
        ShowHint = True
        OnClick = btnImprimirPeriodoCotacaoClick
      end
      object btnNovaCotacao: TSpeedButton
        Left = 274
        Top = 7
        Width = 135
        Height = 44
        Hint = 'Abre Nova Cota'#231#227'o'
