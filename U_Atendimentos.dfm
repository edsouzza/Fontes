object _frmAtendimentos: T_frmAtendimentos
  Left = 484
  Top = 272
  BorderIcons = [biSystemMenu]
  BorderStyle = bsSingle
  Caption = 'Consulta Atendimentos Realizados pelos Profissionais'
  ClientHeight = 535
  ClientWidth = 870
  Color = clBtnFace
  ...
  object pangrid_atendimentos: TPanel
    ...
    object grid_Funcionarios: TDBGrid
      ...
      TitleFont.Style = []
      OnCellClick = grid_FuncionariosCellClick
      Columns = <
        item
          Expanded = False
          FieldName = 'FUNC_NOME'
          Title.Alignment = taCenter
          Title.Caption = 'FUNCIONARIOS'
