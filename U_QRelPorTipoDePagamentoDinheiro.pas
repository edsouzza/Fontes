unit U_QRelPorTipoDePagamentoDinheiro;
...
type
  TQ_RelPorTipoDePagamentoDinheiro = class(TQuickRep)
...
var
  Q_RelPorTipoDePagamentoDinheiro: TQ_RelPorTipoDePagamentoDinheiro;
...
procedure TQ_RelPorTipoDePagamentoDinheiro.QuickRepBeforePrint(
...
procedure TQ_RelPorTipoDePagamentoDinheiro.qrbndDetailBand1BeforePrint(
  Sender: TQRCustomBand; var PrintBand: Boolean);
begin
  TotalValores := TotalValores + cds_RelTiposPagtos.FIELDBYNAME('VALOR').AsCurrency;
end;

procedure TQ_RelPorTipoDePagamentoDinheiro.qrbnd1BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
