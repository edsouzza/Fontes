object _frmConsOrcamentosCancelados: T_frmConsOrcamentosCancelados
  Left = 475
  Top = 160
  BorderIcons = [biSystemMenu]
  BorderStyle = bsSingle
  Caption = 'Or'#231'amentos cancelados ou n'#227'o aprovados pelos clientes'
  ClientHeight = 650
  ClientWidth = 995
  Color = clBtnFace
  ...
  object pangrid_atendimentos: TPanel
    ...
    object grid_Lista: TDBGrid
      ...
      Height = 504
      Cursor = crHandPoint
      Hint = 'Clique no or'#231'amento para reativ'#225'-lo'
      Align = alClient
      Ctl3D = True
      Font.Charset = DEFAULT_CHARSET
      Font.Color = clBlack
  ...
  object pan_titulo: TPanel
    ...
    BorderWidth = 2
    BorderStyle = bsSingle
    Caption = 'Consulta e reativa or'#231'amentos n'#227'o aprovados pelos clientes'
    Color = clMaroon
    Font.Charset = DEFAULT_CHARSET
    Font.Color = clWhite
    Font.Height = -19
