...
begin
     ...
     if (edt_DataFim.Date >= edt_DataInicio.Date) then
      ...
      if lstTiposDeRelatorios.Items[lstTiposDeRelatorios.ItemIndex] = 'RELATÓRIO PERIÓDICO DE VENDAS E ORÇAMENTOS' then
            begin
                 ...
                 begin
                    ...
                    Open;
                        ...
                        begin
                             ...
                             Q_RelMovimentoMensal.ReportTitle          :='Relatório de Vendas e Orçamentos no Período de '+periodo;
                             Q_RelMovimentoMensal.qrbTitulo.Caption    :='Relatório de Vendas e Orçamentos no Período de '+periodo;
                             Q_RelMovimentoMensal.Preview;
                             EstadoInicialDatas;
                        end
                   end;

            end else if lstTiposDeRelatorios.Items[lstTiposDeRelatorios.ItemIndex] = 'RELATÓRIO PERIÓDICO   DO    EXTRATO   DE   CAIXA ' then
            begin
                        ...
                        Open;
                            ...
                            begin
                                ...
                                exit;
                                   ...
                                   Q_RelExtratoCaixa.ReportTitle             :='Relatório Periódico do Extrato de Caixa de '+periodo;
