object _frmConsPedidosPeriodo: T_frmConsPedidosPeriodo
  Left = 463
  Top = 215
  BorderIcons = [biSystemMenu]
  BorderStyle = bsSingle
  Caption = 'Consulta Pedidos Abertos por Per'#237'odo para atualiza'#231#227'o'
  ClientHeight = 650
  ClientWidth = 995
  Color = clBtnFace
  ...
  object pangrid_atendimentos: TPanel
    ...
    object grid_ListaPedidos: TDBGrid
      ...
      Height = 504
      Cursor = crHandPoint
      Hint = 'Abre o pedido selecionado para atualiza'#231#227'o'
      Color = clInfoBk
      Font.Charset = DEFAULT_CHARSET
      Font.Color = clBlack
      Font.Height = -16
  ...
  object pan_botoes: TPanel
    ...
    object GroupBox1: TGroupBox
      ...
      object btnImprimirPeriodoDosPedidos: TSpeedButton
        Left = 183
        Top = 7
        Width = 180
        Height = 44
        Hint = 'Imprime a lista de pedidos do per'#237'odo selecionado'
        Caption = 'Imprimir'
        Enabled = False
        Flat = True
        Font.Charset = DEFAULT_CHARSET
        ...
        ParentShowHint = False
        ShowHint = True
        OnClick = btnImprimirPeriodoDosPedidosClick
      end
    end
  end
end
