unit U_QRelPorTipoDePagamentoParcelado;
...
type
  TQ_RelPorTipoDePagamentoParcelado = class(TQuickRep)
...
var
  Q_RelPorTipoDePagamentoParcelado: TQ_RelPorTipoDePagamentoParcelado;
...
procedure TQ_RelPorTipoDePagamentoParcelado.QuickRepBeforePrint(
...
procedure TQ_RelPorTipoDePagamentoParcelado.qrbndDetailBand1BeforePrint(
  Sender: TQRCustomBand; var PrintBand: Boolean);
begin
  TotalValores := TotalValores + cds_RelTiposPagtos.FIELDBYNAME('VALOR').AsCurrency;
end;

procedure TQ_RelPorTipoDePagamentoParcelado.qrbnd1BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
