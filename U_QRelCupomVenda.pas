...
type
  TQ_RelCupomVenda = class(TQuickRep)
    QRBand1: TQRBand;
    qrsysdt2: TQRSysData;
...
var
  Q_RelCupomVenda: TQ_RelCupomVenda;
...
procedure TQ_RelCupomVenda.QuickRepBeforePrint(Sender: TCustomQuickRep;
  var PrintReport: Boolean);
begin 
