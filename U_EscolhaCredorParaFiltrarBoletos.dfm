object _frmEscolhaCredorParaFiltrarBoletos: T_frmEscolhaCredorParaFiltrarBoletos
  Left = 711
  Top = 267
  BorderIcons = [biSystemMenu]
  BorderStyle = bsSingle
  BorderWidth = 2
  Caption = 'Lista de Credores'
  ClientHeight = 395
  ClientWidth = 564
  Color = clBtnFace
  ...
  object pnl1: TPanel
    ...
    object GridCredores: TDBGrid
      ...
      TitleFont.Style = []
      OnCellClick = GridCredoresCellClick
    end
