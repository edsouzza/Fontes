object _frmGerarDuplicatas: T_frmGerarDuplicatas
  Left = 687
  Top = 270
  ...
  object pan_titulo: TPanel
    ...
    BorderWidth = 2
    BorderStyle = bsSingle
    Caption = 'Gerando duplicatas a pagar'
    Color = clBlue
    Font.Charset = DEFAULT_CHARSET
    Font.Color = clWhite
    Font.Height = -19
  ...
  object pan_botoes: TPanel
    ...
    Color = clBlue
    TabOrder = 1
    object btnGerarDuplicatas: TSpeedButton
      Left = 16
      Top = 10
      Width = 157
      Height = 40
      ...
      ShowHint = True
      OnClick = btnGerarDuplicatasClick
    end
  ...
  object grCabecalho: TGroupBox
    ...
    object Label2: TLabel
      ...
      Width = 250
      Height = 20
      Caption = 'Escolha o prazo de pagamento'
      Font.Charset = DEFAULT_CHARSET
      Font.Color = clBlue
      Font.Height = -16
      Font.Name = 'MS Sans Serif'
    ...
    object DBIDPrazos: TDBEdit
      ...
      Ctl3D = False
      DataField = 'ID_PRAZO'
      DataSource = dm_Conexao.ds_Prazos
      Font.Charset = DEFAULT_CHARSET
      Font.Color = clBlue
      Font.Height = -13
      Font.Name = 'MS Sans Serif'
    ...
    object DBPrazos: TDBLookupComboBox
      Left = 12
      Top = 106
      Width = 507
      Height = 22
      Cursor = crHandPoint
      Hint = 'Selecione os prazos de pagamentos'
      Ctl3D = False
      ...
      KeyField = 'ID_PRAZO'
      ListField = 'PRAZO'
      ListSource = dm_Conexao.ds_Prazos
      ParentCtl3D = False
      ParentFont = False
      ParentShowHint = False
      ShowHint = True
      TabOrder = 5
      OnClick = DBPrazosClick
    end
