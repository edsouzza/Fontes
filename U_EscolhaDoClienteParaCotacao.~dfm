object _frmEscolhaClienteParaCotacao: T_frmEscolhaClienteParaCotacao
  Left = 486
  Top = 168
  BorderIcons = [biSystemMenu]
  BorderStyle = bsSingle
  BorderWidth = 2
  Caption = 'Escolha o cliente para Cota'#231#227'o'
  ClientHeight = 395
  ClientWidth = 564
  Color = clBtnFace
  ...
  object pnl1: TPanel
    ...
    TabOrder = 2
    object grid_clientesCotacao: TDBGrid
      Left = 0
      Top = 44
      Width = 563
      Height = 268
      ...
      TitleFont.Style = []
      OnCellClick = grid_clientesCotacaoCellClick
      Columns = <
        item
          Expanded = False
          Visible = True
