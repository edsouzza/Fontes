...
begin
    ...
    texto := 'Confirma o desejo de bloquear o módulo frente de caixa?';
    if Application.MessageBox(PChar(texto),'Bloqueando Módulo Frente de Caixa!',MB_YESNO + MB_ICONWARNING) = IdYes then
    begin
