...
begin
     ...
     IDNovoFornecedor           := StrToInt(idNovoFornecedorParaAlteracao.Text);
      ...
      begin
       ...
       LogOperacoes(NomeDoUsuarioLogado, 'alteração no cadastro de fornecedores de produto');
...
begin
      close;
      pnl_cabecalho.Caption := 'Alteração de fornecedores de produtos cadastrados';
end;
...
begin
      ...
      if (idProdAlterarFornecedor.Text = '') then
              edtNomeFornecedor.Caption:= 'PRODUTO NÃO LOCALIZADO'
      else
