unit U_QRelPorTipoDePagamentoDebito;
...
type
  TQ_RelPorTipoDePagamentoDebito = class(TQuickRep)
...
var
  Q_RelPorTipoDePagamentoDebito: TQ_RelPorTipoDePagamentoDebito;
...
procedure TQ_RelPorTipoDePagamentoDebito.QuickRepBeforePrint(
...
procedure TQ_RelPorTipoDePagamentoDebito.qrbndDetailBand1BeforePrint(
  Sender: TQRCustomBand; var PrintBand: Boolean);
begin
  TotalValores := TotalValores + cds_RelTiposPagtos.FIELDBYNAME('VALOR').AsCurrency;
end;

procedure TQ_RelPorTipoDePagamentoDebito.qrbnd1BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
