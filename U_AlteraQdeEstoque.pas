...
begin
    ...
    Application.MessageBox('O Estoque Atual do produto foi alterado com sucesso!', 'Confirmação', MB_OK);
    LogOperacoes(NomeDoUsuarioLogado, 'alteração na quantidade do estoque de um produto');
    close;
