...
begin
        ...
        texto := 'Os preços dos produtos desse pedido foram aumentados em ' +(edt_PercentualDeAlteracao.Text)+ '%';
        ...
        LogOperacoes(NomeDoUsuarioLogado, 'alterado preço de venda dos produtos por percentual');
...
begin
       ...
       // perguntar se deseja alterar os valores de venda de todos os ítens deste pedido

       texto:= 'Confirma a alteração dos valores de venda dos ítens deste pedido em ' +(edt_PercentualDeAlteracao.Text)+'% '+'?';
...
begin
     ...
     pnl_cabecalho.Caption := 'Alterar preços de venda dos produtos do pedido Nº '+ _frmFecharPedido.edt_pedido.Caption ;
